...
def actions(user_id):
    ...
    while not exit:
        ...
        user_action=input("Press A for available actions, Q to see your action queue, C to change action status, L to logout ")
        user_action=user_action.lower()
        while user_action!='a' and user_action!='q' and user_action!='c' and user_action!='e':
